...
def custom_append(input_list, value):
    ...
    last_item = custom_len(input_list)
    input_list[last_item:last_item] = [value] 
...
def custom_extend(input_list, second_list):
    ...
    last_item = custom_len(input_list)
    input_list[last_item:last_item] = second_list
...
def custom_pop(input_list):
    ...
    last_item = len(input_list) - 1 
    item = input_list[last_item]
    input_list[last_item:last_item + 1] = []
    return item 
